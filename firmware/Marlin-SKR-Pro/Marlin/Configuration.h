...
#define STRING_CONFIG_H_AUTHOR "BM DuoCube 2" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ultimaker
  #define DEFAULT_Kp 7 //22.2
  #define DEFAULT_Ki 2 //1.08
  #define DEFAULT_Kd 40 //114
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 196 //10.00
  #define DEFAULT_bedKi 33 //.023
  #define DEFAULT_bedKd 290 //305.4
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 160, 6464,159}
